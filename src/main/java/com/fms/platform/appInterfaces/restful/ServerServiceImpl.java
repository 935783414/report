...
import com.fms.platform.common.BaseEntity;
import com.fms.platform.appInterfaces.IServerService;
import com.fms.platform.appInterfaces.InterfaceInfo;
import com.fms.platform.msg.MsgErrorResponse;
import com.fms.platform.service.IServerInfoService;
...
public class ServerServiceImpl extends BaseAppMessage implements IServerService
{
     ...
     * @return
     *
     * @see com.fms.platform.appInterfaces.IServerService#isok()
     */
    @Path("info")
    @GET
     ...
     *
     * @see com.fms.platform.appInterfaces.IServerService#showError()
     */
    @Path("showError")
    @GET
    @Produces(MediaType.TEXT_HTML)
     ...
     * @return
     *
     * @see com.fms.platform.appInterfaces.IServerService#showInterface()
     */
    @Path("showInterface")
    @GET
    @Produces(MediaType.TEXT_HTML)
