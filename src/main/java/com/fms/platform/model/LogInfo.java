...
public class LogInfo extends BaseModel
{
    ...
    /** 日志分组类型 */
    @Doc(index="02" ,info="日志分组类型。最大长度:64英文"                            ,value={"Log.Create.A001"})
    private String               logType;
    
    /** 日志分组种类 */
    @Doc(index="03" ,info="日志分组种类。最大长度:64英文"                            ,value={"Log.Create.A001"})
    ...
    /** 操作备注 */
    @Doc(index="08" ,info="操作备注。最大长度:320英文"                             ,value={"Log.Create.A001"})
    ...
    public void setLogType(String i_LogType)
    {
        ...
        {
            this.validDataCount++;
            this.logType = this.checkMaxLen(i_LogType.trim() ,64);
        }
    }
    ...
    public void setLogClass(String i_LogClass)
    {
        ...
        {
            this.validDataCount++;
            this.logClass = this.checkMaxLen(i_LogClass.trim() ,64);
        }
    }
    ...
    public void setOperationRemark(String i_OperationRemark)
    {
        ...
        {
            this.validDataCount++;
            this.operationRemark = this.checkMaxLen(i_OperationRemark.trim() ,320);
        }
    }
