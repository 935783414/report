...
import com.fms.platform.dao.IServerInfoDAO;
import com.fms.platform.model.DBTableInfo;
...
public class ServerInfoService extends BaseService implements IServerInfoService
{
     ...
     *
     * @see com.fms.platform.service.IServerInfoService#initDB()
     */
    @Override
    public List<Return<String>> initDB()
    {
        ...
        try
        {
            ...
            v_SQLs = this.getFileContent("db.InitDB.v" + this.getDBVersion() + "." + this.getDataSourceType().toLowerCase() + ".sql").split(";");
