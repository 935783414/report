            ...
            <div class="col-md-3">
                <div class="panel-success simple-table enter-panel" >
                    ...
                    <div class="alert alert-success">
                        ...
                        <a href="javascript:;" data-type="ftl" data-data="exam.deptexam.admin"class="btn btn-success enter-btn">点击进入</a>
                    </div>
            ...
            <div class="col-md-3">
                <div class="panel-info simple-table enter-panel">
                    ...
                    <div class=" alert alert-info">
                        ...
                        <a href="javascript:;" data-type="ftl" data-data="warn.deptWarn.admin" class="btn btn-info enter-btn">点击进入</a>
                    </div>
            ...
            <div class="col-md-3">
                <div class="panel-info simple-table enter-panel">
                    ...
                    <div class="alert alert-info">
                        ...
                        <ul class="plan">
                            <li class="price-simple" style="font-size: 20px !important;"><strong>零件完工检测异常数据</strong></li>
            ...
            <div class="col-md-3">
                <div class="panel-warning simple-table enter-panel">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <a href="javascript:;" data-type="ftl" data-data="report.task.porjectdept" class="btn btn-warning enter-btn">点击进入</a>
                    </div>
            ...
            <div class="col-md-3">
                <div class="panel-warning simple-table enter-panel">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <ul class="plan">
                            <li class="price-simple"><strong>考勤报表</strong></li>
                            <li><strong>考勤统计</strong></li>
                            <li><strong>违纪统计</strong></li>
                            <li><strong>异常出入</strong></li>
                        </ul>
                        <a href="javascript:;" data-type="ftl" data-data="report.huizong.statistics" class="btn btn-warning enter-btn">点击进入</a>
                    </div>
            ...
            <div class="col-md-3">
                <div class="panel-success simple-table enter-panel" >
                    ...
                    <div class="alert alert-success">
                        ...
                        <ul class="plan">
                            <li class="price-simple" style="border-bottom:1px solid #c6c6c6;">违纪情况统计</li>
                            <li style="border-bottom:1px solid #c6c6c6;"><strong>违纪情况统计</strong></li>
                            <li style="border-bottom:1px solid #c6c6c6;"><strong>违纪情况分析</strong></li>
                            <li style="border-bottom:1px solid #c6c6c6;"><strong>违纪情况汇总</strong></li>
                        </ul>
                        <a href="javascript:;" data-type="ftl" data-data="report.weiji.discipline"class="btn btn-success enter-btn">点击进入</a>
                    </div>
            ...
            <div class="col-md-3">
                <div class="panel-success simple-table enter-panel" >
                    ...
                    <div class="alert alert-success">
                        ...
                        <ul class="plan">
                            <li class="price-simple" style="border-bottom:1px solid #c6c6c6;">出入异常统计</li>
                            <li style="border-bottom:1px solid #c6c6c6;"><strong>异常情况统计</strong></li>
                            <li style="border-bottom:1px solid #c6c6c6;"><strong>异常情况分析</strong></li>
                            <li style="border-bottom:1px solid #c6c6c6;"><strong>异常情况汇总</strong></li>
                        </ul>
                        <a href="javascript:;" data-type="ftl" data-data="report.yichang.exception"class="btn btn-success enter-btn">点击进入</a>
                    </div>
            ...
            <div class="col-md-3">
                <div class="panel-success simple-table enter-panel" >
                    ...
                    <div class="alert alert-success">
                        ...
                        <ul class="plan">
                            <li class="price-simple" style="border-bottom:1px solid #c6c6c6;">部门树测试</li>
                            <li style="border-bottom:1px solid #c6c6c6;"><strong>部门树测试</strong></li>
                            <li style="border-bottom:1px solid #c6c6c6;"><strong>部门树测试</strong></li>
                            <li style="border-bottom:1px solid #c6c6c6;"><strong>部门树测试</strong></li>
                        </ul>
                        <a href="javascript:;" data-type="ftl" data-data="report.kaoqin.tankuang"class="btn btn-success enter-btn">点击进入</a>
                    </div>
