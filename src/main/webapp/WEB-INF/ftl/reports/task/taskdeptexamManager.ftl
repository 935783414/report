...
<#--toolbar-->
    <div id="toolbar" >
        <button type="button" class="btn btn-warning ladda-button" data-style="contract"  id="saveExam">生成当天考核</button>
    </div>
    <#--end toolbar-->
</div>
<script type="text/javascript">
    ...
    var tableParam = {
        ...
        url : "${ctx}/report/deptexam/examList.z",
        method: 'post',
    ...
    $("#saveExam").click(function () {
        ...
        $.ajax({
            type: 'post',
            url: '${ctx}/report/deptexam/saveDatas.z',
            contentType: "application/x-www-form-urlencoded",
            dataType: 'json',
    ...
    $("#manager-deptexam-table").on('click','.delete-enter',function (e) {
        ...
        $.ajax({
            type: 'post',
            url: '${ctx}/report/deptexam/deleteData.z',
    ...
    $("#manager-deptexam-table").on('click','.operator-detail',function (e) {
        ...
        form2.attr({"method":"post","action":'${ctx}/report/deptexam.z'})
        form2.submit();
